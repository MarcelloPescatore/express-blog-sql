...
const show = (req, res) => {
    ...
    // prepare the sql query to get the posts by its id
    const sql = 'SELECT * FROM posts WHERE id=?'

    // prepare another query to get all the tags associated with that posts
    const tagsSql = `
        SELECT tags.*
        FROM tags
    ...
    connection.query(sql, [id], (err, results) => {
        ...
        // execute the second query to get all the tags associated with that post
